    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50/30 px-4 sm:px-6 lg:px-8 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border-2 border-gray-200 p-8">
          {message && (
            <div
              className={`mb-6 text-sm px-5 py-4 rounded-xl border-2 text-center font-medium ${
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6">
              <label className="block text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                ...
                Mağaza Logosu <span className="text-red-500 text-sm">*</span>
              </label>
                ...
                <div className="mb-4 flex items-center gap-4">
                  <div className="relative">
                    <img
                      src={logoPreview}
                      alt="Logo Önizleme"
                      className="h-24 w-24 rounded-xl border-2 border-white object-cover shadow-lg"
                    />
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  <div className="text-sm text-gray-600">
                    <p className="font-semibold text-gray-800">Logo Önizleme</p>
                    <p className="text-xs">{form.logoFile?.name}</p>
                  </div>
                </div>
              )}
                ...
                <div className="mb-4">
                  <div className="relative">
                    <img
                      src={bannerPreview}
                      alt="Banner Önizleme"
                      className="w-full h-40 rounded-xl border-2 border-white object-cover shadow-lg"
                    />
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  <p className="text-sm text-gray-600 mt-2">{form.bannerFile?.name}</p>
                </div>
              )}
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  {form.categoryIds.map((id) => {
                    ...
                    return (
                      <span
                        key={id}
                        className="inline-flex items-center gap-1 px-3 py-1 text-xs rounded-full bg-emerald-100 text-emerald-700 border-2 border-emerald-200 font-bold"
                      >
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
              >
                {submitting ? (
                  <>
                    <Loader2 className="w-5 h-5 animate-spin" />
                    Mağaza Oluşturuluyor...
                  </>
                ) : (
                  <>
