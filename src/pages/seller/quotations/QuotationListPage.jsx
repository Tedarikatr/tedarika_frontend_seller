  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 px-4 sm:px-6 lg:px-8 py-8">
      <div className="max-w-7xl mx-auto">
        {/* Hero Header */}
        <header className="mb-8 relative bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 rounded-3xl shadow-2xl px-8 py-12 text-center overflow-hidden">
          {/* Dekoratif Arka Plan */}
        ...
        <div className="mb-6 bg-white rounded-2xl shadow-lg p-4 border-2 border-gray-200">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-300 text-gray-800"
            />
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl shadow-lg">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center shadow-xl animate-pulse mb-4">
              <FileText className="w-8 h-8 text-white" />
            </div>
                      ...
                      <tr key={q.id} className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 transition-all duration-200">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-gray-900">{q.storeProductName}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="font-bold text-emerald-600">{q.unitPrice} ₺</span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 font-medium">
                          {q.quantity}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-xl border-2 shadow-sm ${status.color}`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <Link
                            ...
                            className="inline-flex items-center gap-1 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
                          >
                            Detay
                          </Link>
                        </td>
