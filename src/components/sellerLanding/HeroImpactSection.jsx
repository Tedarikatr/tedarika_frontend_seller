...
const HeroImpactSection = () => {
  return (
    <section className="relative bg-white py-20 sm:py-32 px-4 sm:px-8 text-center overflow-hidden">
      <div className="absolute top-0 left-0 w-60 h-60 sm:w-80 sm:h-80 bg-emerald-600 opacity-40 rounded-full blur-3xl z-0" />
      <div className="absolute bottom-0 right-0 w-48 h-48 sm:w-64 sm:h-64 bg-teal-600 opacity-30 rounded-full blur-3xl z-0" />

      <div className="max-w-6xl mx-auto relative z-10">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-black mb-6 sm:mb-8 leading-snug sm:leading-tight px-2">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-xl sm:max-w-2xl mx-auto mb-12 sm:mb-16 px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 text-center">
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
            ...
            <h3 className="font-semibold text-lg sm:text-xl text-[#003636] mb-2">Global Pazarlara Erişim</h3>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
            ...
            <h3 className="font-semibold text-lg sm:text-xl text-[#003636] mb-2">Satışlarınızı Artırın</h3>
            <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
            ...
            <h3 className="font-semibold text-lg sm:text-xl text-[#003636] mb-2">Güvenli Ödeme Alın</h3>
            <p className="text-sm sm:text-base text-gray-600">
