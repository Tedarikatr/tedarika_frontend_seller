// src/components/sellerLanding/PricingSection.jsx
    ...
    return (
      <section className="py-20 bg-green-900 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">Satışa güçlü bir başlangıç yapın</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, idx) => (
              <div
                key={idx}
                className={`rounded-2xl shadow-lg p-8 bg-white text-gray-800 ${
                  plan.highlight ? "border-4 border-green-500 scale-105" : ""
                }`}
              >
                ...
                <button className="mt-6 w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-semibold transition">
                  Hemen Başla
                </button>
              </div>
            ))}
