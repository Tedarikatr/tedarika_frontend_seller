...
const CTASection = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-emerald-600 to-teal-600 text-white py-20 px-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-200 mb-8">
          ...
          <span className="text-emerald-300 font-semibold">Tedarika satıcısı</span>{" "}
        ...
        <motion.button
          ...
          className="bg-emerald-500 text-white hover:bg-emerald-600 font-bold px-8 py-3 rounded-full text-lg shadow-lg transition-all duration-200"
        >
